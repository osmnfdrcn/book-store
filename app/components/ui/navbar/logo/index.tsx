const Logo = () => {
  return (
    <div className="cursor-pointer h-full flex-1">
      ...
      >
        <path
          d="M25.003,30.75c7.435,3.218,12.28-7.191,12.28-13.974c0-6.549-5.038-10.39-11.581-7.503
        ...
        />
        <path
          d="M24.998,7.024c0,0,0.27-3.27-1.58-5.12c-1.853-1.851-5.119-1.579-5.119-1.579s-0.274,3.271,1.578,5.122
			C21.727,7.296,24.998,7.024,24.998,7.024z"
        />
        <path
          fill="#000"
          d="M50,35.35v-3.996H9.168C4.115,31.354,0,35.465,0,40.521c0,5.054,4.115,9.168,9.168,9.168H50v-3.996
