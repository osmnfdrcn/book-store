...
const BookCard = ({ book }: Props) => {
  return (
    <div className="relative  h-auto transition duration-200 bg-slate-100 pt-4 brightness-100 hover:brightness-95 hover:scale-105  flex flex-col shadow-sm items-center justify-center">
